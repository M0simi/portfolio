...
def events_list(request):
    ...
    return render(request, "custom_admin/list.html", {
        "title": "الأحداث",
        "create_url": "custom_admin:events_create",
        "edit_url_name": "custom_admin:events_edit",
        "delete_url_name": "custom_admin:events_delete",
        "page_obj": page,
        "columns": columns,
        "search_placeholder": "ابحث في العنوان/الوصف/المكان…",
    })
...
def events_delete(request, pk):
    ...
    if request.method == "POST":
        obj.delete()
        messages.success(request, "تم حذف الحدث.")
        return redirect("custom_admin:events_list")
...
def categories_list(request):
    ...
    return render(request, "custom_admin/list.html", {
        "title": "الفئات",
        "create_url": "custom_admin:categories_create",
        "edit_url_name": "custom_admin:categories_edit",
        "delete_url_name": "custom_admin:categories_delete",
        "page_obj": page,
        "columns": columns,
...
def faqs_list(request):
    ...
    return render(request, "custom_admin/list.html", {
        ...
        "create_url": "custom_admin:faqs_create",
        "edit_url_name": "custom_admin:faqs_edit",
        "delete_url_name": "custom_admin:faqs_delete",
        "page_obj": page,
        "columns": columns,
        "search_placeholder": "ابحث في السؤال/الإجابة/الفئة…",
    })
...
def favorites_delete(request, pk):
    ...
    if request.method == "POST":
        obj.delete()
        messages.success(request, "تم حذف العنصر من المفضلة.")
...
def feedback_list(request):
    ...
    page = _paginate(request, qs)
    columns = [("السؤال", "faq"), ("المستخدم", "user"), ("مفيد؟", "helpful"),
               ("التعليق", "comment"), ("التاريخ", "created_at")]
    return render(request, "custom_admin/list.html", {
        "title": "التعليقات",
        "page_obj": page,
        "columns": columns,
...
def users_list(request):
    ...
    return render(request, "custom_admin/list.html", {
        "title": "المستخدمون",
        "create_url": "custom_admin:users_create",
        "edit_url_name": "custom_admin:users_edit",
        "delete_url_name": "custom_admin:users_delete",
        "page_obj": page,
        "columns": columns,
        "search_placeholder": "ابحث بالبريد/الاسم/الدور…",
    })
...
def kb_list(request):
    ...
    return render(request, "custom_admin/list.html", {
        ...
        "create_url": "custom_admin:kb_upload",
        "edit_url_name": None,
        "delete_url_name": "custom_admin:kb_delete",
        "page_obj": page,
        "columns": columns,
